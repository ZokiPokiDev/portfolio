...
import apacheLogo from '../assets/apache.svg';
import apachesolrLogo from '../assets/apachesolr.svg';
import apachekafkaLogo from '../assets/apachekafka.svg';
import rabbitmqLogo from '../assets/rabbitmq.svg';
import simpleiconsLogo from '../assets/simpleicons.svg';
...
import snykLogo from '../assets/snyk.svg';
...
const groupedTechStack = {
  ...
  "DevOps": [
    ...
    { name: 'Apache Solr', logo: apachesolrLogo },
  ...
  "Mobile": [
    ...
    { name: 'Apache Cordova', logo: apachecordovaLogo },
  ],
};
