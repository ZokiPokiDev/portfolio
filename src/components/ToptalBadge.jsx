...
const ToptalBadge = () => {
  return (
    <>
      {/* Compact badge for mobile portrait */}
      <a 
        href="https://www.toptal.com/developers/resume/zoran-panev#gz1yJW"
        target="_blank"
        rel="noopener noreferrer"
        className="toptal-badge-link compact"
