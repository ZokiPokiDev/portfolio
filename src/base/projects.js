...
import ktm1 from '../assets/ktm1.png';
...
export const projects = [
    {
        ...
        impact: "Give consultancy services and contribute to the mobile app & backend SAP ecommerce platform.",
    },
    {
        id: "vw",
        name: "VW (Porsche)",
        ...
        role: "Senior developer & engineer",
        tech: "Flutter, Java Platform, Angular, SAP",
        image: volkswagenLogo,
        gallery: [vw1, vw2, vw3, vw4],
        impact: "Was a part of innovative automotive platform, integrating modern client design and platform extension.",
    },
    {
        id: "ivote",
        ...
        impact: "Contribute to the core and live codebase and delivered real-time voting experience.",
    },
    {
        id: "planet",
    ...
    },
    {
        ...
        impact: "Led the project, integrate ERP, laboratory and medial data, game processing, design data flow and data modeling.",
    },
    {
        id: "dach",
        ...
        role: "Contractor",
        tech: "CMS, APIs, React.js, Bootstrap, Symfony PHP Framework, MySQL, Preact.js, Redis, React-Native Mobile Apps",
        image: dach1,
        gallery: [dach1, dach2, dach3, dach4],
        impact: "Made CMS platfrom for B2B page building and mobile apps per business.",
    },
    {
        id: "whmcs",
    ...
    },
    {
        ...
        role: "Contractor",
        image: ecomm1,
        tech: "WordPress + WooCommerce, Magento 2, Drupal, Strapi + React.js, ERP integration, APIs, React.js, MUI, WoodMart theme, React-Native mobile apps",
        gallery: [ecomm1, ecomm2, ecomm3, ecomm4, ecomm5, ecomm6],
        impact: "Made e-commerce platforms for various businesses.",
    },
    {
        id: "email-campaign",
        name: "Email Campaign Platform (SaaS)",
        description: "Bulk email, analytics, and automation SaaS.",
        role: "Code owner, Platform architect, Contractor",
        tech: "Symfony PHP Framework, Nest.js APIs, SaaS, React.js, MUI",
        image: advivusLogo,
        gallery: [advivus1, advivus2, advivus3, advivus4, advivus5],
        impact: "Made SaaS platform for email campaign management and analytics, with setup to send up to 10k emails/per day.",
    },
    {
        id: "pdf-reader",
        ...
        impact: "Build SaaS platform for PDF reading and analysis, with AI-powered features.",
    },
    {
        id: "dazn",
        ...
        impact: "Led the mobile team to build a sports streaming app.",
    },
    {
        id: "business-locator",
        name: "Business Locator",
        description: "Map geolocation with google maps and geofire for business discovery and B2B multi-lingual CMS portal.",
        role: "Lead mobile engineer & architect",
        image: map1,
        tech: "React Native, Geofire, Google Maps API",
        gallery: [map1, map2, map3, map4],
        impact: "Architect, design & build mobile app for business discovery and B2B multi-lingual CMS portal.",
    },
    {
        id: "e-learning",
        ...
        impact: "Made education platform for B2B clients.",
    },
    {
        id: "javenit",
        name: "JavenIT (www.javenit.com) [EN: PublicIT]",
        link: "https://javenit.com",
        description: "Public & Government sector solutions.",
        image: javenitLogo,
        role: "Contractor",
